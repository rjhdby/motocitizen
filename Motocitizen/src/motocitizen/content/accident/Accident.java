...
import motocitizen.rows.accidentList.ActiveCommonRow;
import motocitizen.rows.accidentList.ActiveOwnedRow;
import motocitizen.rows.accidentList.EndedCommonRow;
import motocitizen.rows.accidentList.EndedOwnedRow;
import motocitizen.rows.accidentList.HiddenCommonRow;
import motocitizen.rows.accidentList.HiddenOwnedRow;
...
//    }
    ...
    public Row makeListRow(Context context) {
        if (isOwner()) {
            if (isHidden()) return new HiddenOwnedRow(context, this);
            else if (isEnded()) return new EndedOwnedRow(context, this);
            else return new ActiveOwnedRow(context, this);
        } else {
            if (isHidden()) return new HiddenCommonRow(context, this);
            else if (isEnded()) return new EndedCommonRow(context, this);
            else return new ActiveCommonRow(context, this);
        }
    }
}
